...
<body>
  <div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="/admin/home" class="flex items-center justify-between mr-4">
    ...
    <aside
      ...
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <ul class="space-y-2">
          ...
          <li>
            <a href="/users"
              class="flex items-center p-2 text-base font-medium text-white  rounded-lg  group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor"
                class="w-6 h-6 transition duration-75 text-white"
                fill="currentColor">
    ...
    <main class="p-4 md:ml-64  h-screen py-52">
     <div class="px-16">
     <section class="bg-gray-50 dark:bg-gray-900 py-20 sm:py-5">
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                          ...
                          <th scope="col" class="px-2 py-3">Telephone</th>
                  ...
                  <tbody>
                     ...
                     <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <img src="{{ asset('storage/' . $item->avatar) }}" class="w-6 h-6 mr-1 rounded-full" alt="">     
                          {{$item->first_name}}
                          </th>
                          <td class="px-4 py-2">
                              <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{$item->last_name}}</span>
                          </td>
                          ...
                          <td class="px-4 py-2">
                              <a href="{{ route('destroyUser', ['id' => $item->id]) }}" class="bg-primary-100 text-red-700 text-xs font-medium px-2 py-0.5 rounded ">Delete</a>
                          </td>
                      </tr>
                     @endforeach
                  </tbody>
